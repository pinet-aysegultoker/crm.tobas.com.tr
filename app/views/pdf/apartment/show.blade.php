...
@section('content')
    ...
    <div class="pdf-header">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xs-8">
                    <h3 class="text-center pdf-title">KuzeyKent Konut Bilgi Formu</h3>
                </div>
                <div class="col-xs-2">
    ...
    <div class="pdf-content">
        <div class="container-fluid">
            ...
            <?php
                $kdv_haric_fiyat = $apartment->price;
                if($apartment->net_area>=150) {
                    $kdv_bedeli = $kdv_haric_fiyat*0.18;
                } else {
                    $kdv_bedeli = $kdv_haric_fiyat*0.01;
                }
                $toplam_fiyat = $kdv_haric_fiyat + $kdv_bedeli;
            ?>
            <div class="row">
                <div class="col-xs-2 pdf-border text-right">
                    <b>KDV Hariç Fiyat:</b>
                ...
                <div class="col-xs-2 pdf-border text-right ">
                    <b>KDV Dahil Fiyat(1%):</b>
                </div>
                <div class="col-xs-2 pdf-border">
                    {{ number_format($toplam_fiyat, 2, ',', '.') }} TL
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-xs-12 pdf-border padding-zero">
                    <table class="table pdf-table col-xs-12">
                        ...
                        <tr>
                            ...
                            <td class="info">{{ number_format($kdv_haric_fiyat*0.1, 2, ',', '.') }} TL</td>
                            <td class="info">{{ number_format(($kdv_haric_fiyat-($kdv_haric_fiyat*0.1))/96, 2, ',', '.') }} TL</td>
                            <td class="info">96 Ay</td>
                        </tr>
                        <tr>
                            <td class="warning">15% Peşin / 108 Ay Vade</td>
                            <td class="info">{{ number_format($kdv_haric_fiyat*0.15, 2, ',', '.') }} TL</td>
                            <td class="info">{{ number_format(($kdv_haric_fiyat-($kdv_haric_fiyat*0.15))/108, 2, ',', '.') }} TL</td>
                            <td class="info">108 Ay</td>
                        </tr>
                        <tr>
                            <td class="warning">25% Peşin / 120 Ay Vade</td>
                            <td class="info">{{ number_format($kdv_haric_fiyat*0.25, 2, ',', '.') }} TL</td>
                            <td class="info">{{ number_format(($kdv_haric_fiyat-($kdv_haric_fiyat*0.25))/120, 2, ',', '.') }} TL</td>
