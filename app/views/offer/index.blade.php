        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-crm">
                    <div class="panel-heading"><h1><i class="fa fa-eye" aria-hidden="true"></i> Teklifleri Görüntüle</h1></div>
                    ...
                    <div class="panel-footer">
                        <div class="btn-group btn-group-justified" role="group">
                            <div class="btn-group" role="group">
                                <a type="button" class="btn btn-xl btn-success" href="{{ route('offer.create') }}" role="button"><i class="fa fa-plus" aria-hidden="true"></i> Yeni Bir Teklif Oluştur</a>
                            </div>
                            <div class="btn-group" role="group">
                                <a type="button" class="btn btn-xl btn-info" href="{{ route('payment-plan.index') }}" role="button"><i class="fa fa-eye" aria-hidden="true"></i> Ödeme Planlarını Görüntüle</a>
                            </div>
                        </div>
                    </div>
                </div>
