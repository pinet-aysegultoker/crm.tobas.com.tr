...
@section('title', 'Bir Projeyi Görüntüle')
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-crm">
                    <div class="panel-heading"><h1><i class="fa fa-eye" aria-hidden="true"></i> Bir Projeyi Görüntüle</h1></div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    {{ Form::text('başlık',$project->title,array('class'=>'form-control','id'=>'başlık','placeholder'=>'Başlık','disabled'=>'disabled')) }}
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    {{ Form::select('durum', $status_array, $project->status, array('id'=>'durum','class'=>'form-control','disabled'=>'disabled')) }}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    {{ Form::textarea('detaylar',$project->details,array('class'=>'form-control','id'=>'detaylar','placeholder'=>'Detaylar','disabled'=>'disabled')) }}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <a class="btn btn-lg btn-info btn-block" href="{{ route('project.index') }}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Geri Dön</a>
                            </div>
                        </div>
                        {{ Form::close() }}
                    </div>
                ...
                <div class="panel panel-crm">
                    <div class="panel-heading"><h1><i class="fa fa-eye" aria-hidden="true"></i> Blokta Yer Alan Daireler</h1></div>
                    <div class="panel-body">
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-justified" role="group">
                                                <div class="btn-group" role="group">
                                                    <a type="button" class="btn btn-xs btn-info" href="{{ route('building.show', $building->id) }}" role="button"><span class="fa fa-eye" aria-hidden="true"></span></a>
                                                </div>
                                                <div class="btn-group" role="group">
